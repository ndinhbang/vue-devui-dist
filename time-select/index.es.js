...
function useSelect(props, selectRef, ctx, focus, blur, isSelectFocus, t) {
...
var Option = defineComponent({
  ...
  setup(props, ctx) {
    ...
    return () => {
      ...
      }, [((_a = ctx.slots) == null ? void 0 : _a.default) ? ctx.slots.default() : currentName.value]), [[vShow, isVisible.value]]);
    };
  }
});
...
function useTimeSelect(props, ctx) {
  const select2 = ref();
  const padTime = (time) => {
...
export { TimeSelect, index as default };
