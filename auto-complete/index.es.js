...
var AutoComplete = defineComponent({
  ...
  setup(props, ctx2) {
    ...
    return () => {
      ...
      return withDirectives(createVNode("div", {
      ...
      }, [ctx2.slots.prefix && ((_d = (_c = ctx2.slots).prefix) == null ? void 0 : _d.call(_c)), props.prefix && createVNode(Icon, {
        "size": "inherit",
        "name": props.prefix
        ...
        "size": "inherit",
        "name": props.suffix
      }, null), ctx2.slots.suffix && ((_f = (_e = ctx2.slots).suffix) == null ? void 0 : _f.call(_e)), showClearable.value && createVNode(Icon, {
