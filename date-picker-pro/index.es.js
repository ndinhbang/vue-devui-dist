...
const resetActiveTimeData = (list) => {
  list.forEach((item) => {
    item.isActive = false;
  });
};
...
function usePickerPro(props, ctx, t) {
  ...
  const displayDateValue = computed(() => {
    const formatDate = formatDayjsToStr(dateValue.value, format2.value, props.type);
    if (formatDate) {
      return formatDate;
    }
    return "";
  ...
  const onSelectedDate = (date4, isConfirm) => {
    const result = date4 ? date4.toDate() : date4;
...
function useCalendarPanel(props, ctx) {
...
function useTimePickerPanel(props, ctx) {
  const timeListDom = ref();
...
function useYearCalendarPanel(props, ctx) {
  ...
  const initYearList = () => {
    ...
    yearList.value = lodash.exports.chunk(list, 3);
  };
  ...
  const isInRangeYear = (year) => {
    ...
    const isIn = rangeSelectDate.value[0] && rangeSelectDate.value[0].year() < year && rangeSelectDate.value[1] && rangeSelectDate.value[1].year() > year;
    return isIn ? true : false;
  };
...
function useDatePicker(props, ctx) {
  ...
  const onSelectedDate = (date4) => {
    if (Array.isArray(date4)) {
      ...
      if (!props.showTime) {
        ctx.emit("selectedDate", date4, date4[0] && date4[1] && props.focusType === "end" ? true : false);
      } else {
        ctx.emit("selectedDate", getRangeSelectedDate(date4), false);
      }
    } else {
      currentDate.value = date4;
      if (!props.showTime) {
        ctx.emit("selectedDate", date4, true);
      } else {
        ctx.emit("selectedDate", getSelectedDate(date4), false);
      }
    }
  };
  ...
  const onChangeRangeFocusType = (type4) => {
    ctx.emit("changeRangeFocusType", type4);
  };
  return {
    calendarPanelRef,
    timeData,
  ...
  setup(props, ctx) {
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "onSelectedDate": onSelectedDate,
        "onChangeRangeFocusType": onChangeRangeFocusType
      }), null), ((_a = ctx.slots) == null ? void 0 : _a.rightArea) && createVNode("div", {
        "class": ns2.e("panel-right-area")
      }, [(_b = ctx.slots) == null ? void 0 : _b.rightArea()])]), ((_c = ctx.slots) == null ? void 0 : _c.footer) && createVNode("div", {
        "class": ns2.e("panel-footer")
      }, [(_d = ctx.slots) == null ? void 0 : _d.footer()]), !((_e = ctx.slots) == null ? void 0 : _e.footer) && props.showTime && createVNode("div", {
        "class": ns2.e("panel-footer")
      }, [createVNode("div", {
...
var DatePickerPro = defineComponent({
  ...
  setup(props, ctx) {
    ...
    return () => {
      var _a, _b;
      const vSlots = {
        rightArea: ((_a = ctx.slots) == null ? void 0 : _a.rightArea) && (() => renderSlot(useSlots(), "rightArea")),
...
export { DRangeDatePickerPro, DatePickerPro, datePickerProCommonProps, datePickerProPanelProps, datePickerProProps, index as default, timerPickerPanelProps };
